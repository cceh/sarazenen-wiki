...
java -jar $saxon -s:$master -xsl:$scripts/03-Quellenstellen.xsl -o:$output/3-QuellenEinzelseiten.xml fid=400 sid=2;

java -jar $saxon -s:$master -xsl:$scripts/04-kategorien.xsl -o:$output/4-kategorienseiten.xml fid=2000 sid=2;
