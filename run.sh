...
java -classpath /usr/share/java/saxon9he.jar net.sf.saxon.Transform -s:$files/Negativquellen_ergaenzt.xml -xsl:$scripts/02-Werkliste.xsl -o:$output/2-Werkliste.xml